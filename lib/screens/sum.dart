...
class Sum_Screen extends StatefulWidget {
  const Sum_Screen({super.key});

  @override
  State<Sum_Screen> createState() => _Sum_ScreenState();
}

class _Sum_ScreenState extends State<Sum_Screen> {
  @override
          ...
          children: [
            Row(
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.only(top: 60, left: 127),
                  child: Container(
                    child: const Text(
                      'Sum',
                      style:
              ...
              child: Center(
                child: Stack(
                  children: [
                    ...
                    Container(
                      width: 320,
                      margin: const EdgeInsets.only(top: 340, left: 15),
                      child: TextFormField(
                        cursorColor: Colors.grey,
                        decoration: const InputDecoration(
                          fillColor: Colors.grey,
                    ...
                    const Padding(
                      padding: EdgeInsets.only(top: 410, left: 10),
                      child: SizedBox(
                        child: Text(
                          'Real part(e)',
                          style: TextStyle(fontWeight: FontWeight.bold),
                    ...
                    const Padding(
                      padding: EdgeInsets.only(top: 410, left: 175),
                      child: SizedBox(
                        child: Text(
                          'The i coefficient (f)',
                          style: TextStyle(fontWeight: FontWeight.bold),
                    ...
                    Row(
                      children: [
                        Container(
                          width: 150,
                          margin: const EdgeInsets.only(top: 440, left: 15),
                          child: TextFormField(
                            cursorColor: Colors.grey,
                            decoration: const InputDecoration(
                              fillColor: Colors.grey,
                    ...
                    const Padding(
                      padding: EdgeInsets.only(top: 510, left: 10),
                      child: SizedBox(
                        child: Text(
                          'The j coefficient (g)',
                          style: TextStyle(fontWeight: FontWeight.bold),
                    ...
                    const Padding(
                      padding: EdgeInsets.only(top: 510, left: 175),
                      child: SizedBox(
                        child: Text(
                          'The k coefficient (h)',
                          style: TextStyle(fontWeight: FontWeight.bold),
                    ...
                    Row(
                      children: [
                        Container(
                          width: 150,
                          margin: const EdgeInsets.only(top: 540, left: 15),
                          child: TextFormField(
                            cursorColor: Colors.grey,
                            decoration: const InputDecoration(
                              fillColor: Colors.grey,
            ...
            Padding(
              padding: const EdgeInsets.only(top: 830, left: 115),
              child: Container(
                height: 55,
                width: 200,
                decoration: BoxDecoration(
