...
class Matrix_Screen extends StatefulWidget {
  const Matrix_Screen({super.key});

  @override
  State<Matrix_Screen> createState() => _Sum_ScreenState();
}

class _Sum_ScreenState extends State<Matrix_Screen> {
  @override
          ...
          children: [
            Row(
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.only(top: 55, left: 45),
                  child: Container(
                    height: 50,
                    width: 50,
                    decoration: const BoxDecoration(
