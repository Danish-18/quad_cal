...
class Conjugate_Screen extends StatefulWidget {
  const Conjugate_Screen({super.key});

  @override
  State<Conjugate_Screen> createState() => _Sum_ScreenState();
}

class _Sum_ScreenState extends State<Conjugate_Screen> {
  @override
