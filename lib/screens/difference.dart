...
class Differece_Screen extends StatefulWidget {
  const Differece_Screen({super.key});

  @override
  State<Differece_Screen> createState() => _Sum_ScreenState();
}

class _Sum_ScreenState extends State<Differece_Screen> {
  @override
